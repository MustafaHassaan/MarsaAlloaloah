...
{
    public partial class frmTransferTreasuryToBank : Form
    {
        public frmTransferTreasuryToBank()
        {
            InitializeComponent();
        }

        private void frmTransferTreasuryToBank_Load(object sender, EventArgs e)
        {
            GetBankAccountName();
            GetTreasuryList();
        }
        ...
        private void btnClose_Click(object sender, EventArgs e)
        {
            try
            {
                if ((MessageBox.Show("هل تريد بالتأكيد الإنهاء", "تحويل الأموال - من الخزينة إلى الحساب البنكي", MessageBoxButtons.YesNo, MessageBoxIcon.Question)) == DialogResult.Yes)
                {
                    this.Close();
                }
            }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                Interaction.MsgBox("الرجاء إدخال المبلغ.", MsgBoxStyle.Information, "تحويل الأموال - من الخزينة إلى الحساب البنكي");
                return;
            }
            ...
            try
            {
                ...
                SQLConn.UpdateBankAccountTransactions((int)cmbBankAccount.SelectedValue, amountBank, "تحويل الأموال - من الخزينة إلى الحساب البنكي", SQLConn.trans);
                SQLConn.UpdateUserTreasury((int)cmbTreasury.SelectedValue, -amountBank, SQLConn.trans);
                SQLConn.UpdateUserTreasuryTransactions((int)cmbTreasury.SelectedValue, -amountBank, SQLConn.trans, (int)cmbBankAccount.SelectedValue , "تحويل الأموال - من الخزينة إلى الحساب البنكي");
                SQLConn.trans.Commit();

                Interaction.MsgBox("تم تحديث البيانات بنجاح", MsgBoxStyle.Information, "تحويل الأموال - من الخزينة إلى الحساب البنكي");
